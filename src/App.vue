<template>
  <v-app>
    <v-app-bar app>
      <v-btn icon tile x-large href="https://zhangzisu.cn/" target="_blank" style="margin-left: -8px;">
    ...
    <div id="z-bg">
      <!-- <v-img
        src="https://proxy.zhangzisu.cn/pximg/img-original/img/2019/04/09/21/13/01/74125498_p0.png"
        contain
        height="100%"
      /> -->
    </div>
    <v-footer dark app>
      <v-row justify="end" no-gutters>
        <v-col cols="12" sm="auto" class="text-right">
          <v-btn text disabled class="text-none"> &copy; {{ new Date().getFullYear() }} ZhangZisu </v-btn>
        </v-col>
        <v-col cols="auto">
          <v-tooltip top>
